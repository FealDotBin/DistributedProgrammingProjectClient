 ...
 * @author CATELLO
 */
public class ProviderSignIn extends javax.swing.JFrame {

    /**
     * Creates new form ProviderSignIn
     */
    public ProviderSignIn() {
        try {
            //   UIManager.
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProviderSignIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProviderSignIn().setVisible(true);
            }
        });
    }
