...
/**
 * This class represents the view with which the user interacts to display his order history
 * @author CATELLO
 * 
 */
public class CustomerFrameHistory1 extends javax.swing.JFrame {
    ...
    public CustomerFrameHistory1() {
        try {
            ...
            Logger.getLogger(CustomerFrameHistory1.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
        this.pack();
