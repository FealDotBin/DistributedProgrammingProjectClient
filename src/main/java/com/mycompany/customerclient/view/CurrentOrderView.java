 ...
 *
 * @author CATELLO
 * This class represents the view with which the user interacts to display information about his current order
 */
public class CurrentOrderView extends javax.swing.JFrame {
    ...
    public CurrentOrderView() {
        try {
            ...
            Logger.getLogger(CurrentOrderView.class.getName()).log(Level.SEVERE, null, ex);
        }
        initComponents();
        this.pack();
